...
LOCAL_DIR="ANDROID/DIRECTORY/YOU/WANT/TO/OBTAIN/FILES/FROM" # Change this to the desired local directory
REMOTE_PARENT="gdrive:/PARENT-DIRECTORY-IN-G-DRIVE-TO-SAVE" # Change this to the desired parent directory in Google Drive, the script creates an automatic folder in gdrive, no need to create it in gdrive in advanced

# Customizable variables for folder and remote directory
FOLDER_NAME="FOLDER-NAME"  # Change this to the desired folder name
